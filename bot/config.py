...
class Config:
    ...
    music_sources: list[str] = field(default_factory=lambda: ["soundcloud", "audius", "ytmusic", "youtube"])
...
def load_config() -> Config:
    ...
    sources_raw = os.getenv("MUSIC_SOURCES", "soundcloud,audius,ytmusic,youtube")
